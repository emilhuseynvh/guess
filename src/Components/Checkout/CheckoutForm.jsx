    ...
    return (
        <div className='w-full'>
            ...
            <div style={{ fontFamily: 'futura, sans-serif' }}>
                ...
                <div>
                    {method.map((item, i) => <Method checkboxCircle={checkboxCircle} setCheckboxCircle={setCheckboxCircle} key={i} item={item} i={i} />)}
                </div>
                <button className='w-full bg-black text-white my-4 py-4'>Pay now</button>
            </div>
        </div>
    )
}
