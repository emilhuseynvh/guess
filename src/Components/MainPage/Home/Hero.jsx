            ...
            <div className='relative md:text-black text-white'>
                ...
                <div className='md:mt-[14%] md:ml-[50%] top-[50%]  left-1/2 -translate-x-1/2 absolute h-full w-full md:left-0 md:top-0'>
                    ...
                    <div className='md:ml-[50%] md:mr-[5%] flex justify-center mt-[3%] md:mt-[2%] gap-[8%]'>
                        <button onClick={() =>  navigate({ pathname: '/products/all', search: `?categoryId=14`})} className='tracking-wider text-[2.8vw] hover:border-black text-center md:text-[1.31rem]  border-[1px]  text-black px-[7%] bg-white md:bg-transparent md:border-[#010101] border-white rounded-[25px] py-[10px] md:px-[7%] hover:bg-black hover:text-white duration-300'>WOMEN'S</button>
                        <button onClick={() =>  navigate({ pathname: '/products/all', search: `?categoryId=1`})} className='tracking-wider text-[2.8vw] hover:border-black md:text-[1.31rem]  border-[1px] bg-white md:bg-transparent px-[7%] md:border-[#010101] border-white rounded-[25px] text-black py-[10px] md:px-[9%] hover:bg-black hover:text-white duration-300'>MEN'S</button>
                    </div>
                </div>
            </div>
        </div>
